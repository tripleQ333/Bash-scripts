...
# Where the Info.svg template lives.
# Override per machine with:
#   export WRITEUP_TEMPLATE_ROOT="/path/to/Binary-Exploitation-CTFs"
template_root="${WRITEUP_TEMPLATE_ROOT:-$HOME/Binary-Exploitation-CTFs}"
...
## Challenge Overview
<!-- Add the challenge statement here. Drop a screenshot in Images/ and link it, e.g. ![statement](Images/statement.png) -->
> Add the challenge description here.

## Approach
<!-- Walk through how you solved it, step by step. -->
